...
class HistoryBody3 extends StatelessWidget {
  const HistoryBody3({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body:  SingleChildScrollView(
        child: Column(children: [
          const SelectBetweenScreen(past: true,isOngoing: false,text1: 'Ongoing',text2: 'Past',),
